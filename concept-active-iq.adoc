...
Änderung für die Lokalisierung. Aktivieren Sie die Anzeige von docbot und Test loc. Die Deaktivierung von Docbot wird getestet. Ein drittes Mal ein Upgrade von ruby testen. Test Push-of-Ruby-Upgrade.
