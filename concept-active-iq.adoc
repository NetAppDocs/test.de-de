...
Änderung für die Lokalisierung. Aktivieren Sie die Anzeige von docbot und Test loc. Die Deaktivierung von Docbot wird getestet. Ruby-Upgrade wird getestet.
